...
const Steps = () => {
  ...
  return (
    <section class="w-full bg-[#f5f6f8] px-6 py-20">
      <div class="mx-auto max-w-6xl">
        <div class="text-center">
          <h2 class="text-4xl  tracking-tight text-slate-900 font-bold md:text-5xl">
        ...
        <div class="mt-14 grid  gap-6 md:grid-cols-3">
          <div class="relative cursor-pointer transition duration-300 hover:scale-105 rounded-2xl border border-slate-200 bg-white px-8 py-12 text-center shadow-sm">
            ...
            <h3 class="mt-6 text-[30px] font-semibold leading-none text-slate-800 md:text-[28px]"></h3>
            <h3 class="mt-6 text-3xl font-semibold text-slate-800 sm:text-2xl">
              Create Account
            </h3>
            <p class="mx-auto mt-4 max-w-[240px] text-sm leading-6 text-slate-400">
          ...
          <div class="relative cursor-pointer transition duration-300 hover:scale-105 rounded-2xl border border-slate-200 bg-white px-8 py-12 text-center shadow-sm">
            ...
            <div class="mx-auto justify-center flex h-16 w-16 items-center rounded-full bg-violet-100 text-violet-600">
              <img src="src/img/Group 6 (1).png" alt="" />
            </div>

            <h3 class="mt-6 text-3xl font-semibold text-slate-800 sm:text-2xl">
              Choose Products
            </h3>
            <p class="mx-auto mt-4 max-w-[250px] text-sm leading-6 text-slate-400">
          ...
          <div class="relative cursor-pointer transition duration-300 hover:scale-105 rounded-2xl border border-slate-200 bg-white px-8 py-12 text-center shadow-sm">
            ...
            <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-violet-100 text-violet-600">
              <img src="src/img/Group 6 (2).png" alt="" />
            </div>
